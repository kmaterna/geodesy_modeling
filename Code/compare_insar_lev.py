...
def one_to_one_comparison(myLev, InSAR_Data, vector_index, lev1, lev2, sat, output_dir):
	...
	axarr[1][0].set_title(sat+": "+dt.datetime.strftime(InSAR_Data.starttime,"%m-%Y")+" to "+dt.datetime.strftime(InSAR_Data.endtime,"%m-%Y"),fontsize=15);
	...
	axarr[1][1].scatter(InSAR_Data.lon, InSAR_Data.lat, c=InSAR_Data.LOS, s=8,
...
def drive_ou_cornell_comparison(Leveling_Obj, leveling_slice, data_file, los_file, s1_slice, output_dir):
...
if __name__=="__main__":
	...
	output_dir="S1_OU/T4D/"; leveling_slice=[5,6]; s1_slice=0;
	drive_ou_cornell_comparison(myLev, leveling_slice, file_dict["s1_ou_ascending"], file_dict["s1_ou_ascending_los"], s1_slice, output_dir+'ascending_');
	drive_ou_cornell_comparison(myLev, leveling_slice, file_dict["s1_ou_descending"], file_dict["s1_ou_descending_los"], s1_slice, output_dir+'descending_');

	# # S1_Cornell experiment (2016 data)
	output_dir="S1_OU/T4E/"; leveling_slice=[6,7]; s1_slice=1;
	drive_ou_cornell_comparison(myLev, leveling_slice, file_dict["s1_ou_ascending"], file_dict["s1_ou_ascending_los"], s1_slice, output_dir+'ascending_');
	drive_ou_cornell_comparison(myLev, leveling_slice, file_dict["s1_ou_descending"], file_dict["s1_ou_descending_los"], s1_slice, output_dir+'descending_');

	# # S1_Cornell experiment (2017 data)
	output_dir="S1_OU/T4F/"; leveling_slice=[7,8]; s1_slice=2;
	drive_ou_cornell_comparison(myLev, leveling_slice, file_dict["s1_ou_ascending"], file_dict["s1_ou_ascending_los"], s1_slice, output_dir+'ascending_');
	drive_ou_cornell_comparison(myLev, leveling_slice, file_dict["s1_ou_descending"], file_dict["s1_ou_descending_los"], s1_slice, output_dir+'descending_');

	# # S1_Cornell experiment (2018 data)
	output_dir="S1_OU/T5/"; leveling_slice=[8,9]; s1_slice=3;
	drive_ou_cornell_comparison(myLev, leveling_slice, file_dict["s1_ou_ascending"], file_dict["s1_ou_ascending_los"], s1_slice, output_dir+'ascending_');
	drive_ou_cornell_comparison(myLev, leveling_slice, file_dict["s1_ou_descending"], file_dict["s1_ou_descending_los"], s1_slice, output_dir+'descending_');	
