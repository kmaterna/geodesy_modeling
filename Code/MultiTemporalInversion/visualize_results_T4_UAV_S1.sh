...
echo "-115.54 33.098 Data" | gmt pstext -R -J$projection -F+f18p,Helvetica-bold -N -K -O >> $output
...
gmt psxy $field_file -R -J$proj -Wthin,indianred -O -K >> $output
echo "-115.54 33.098 Model" | gmt pstext -R -J$projection -F+f18p,Helvetica-bold -N -K -O >> $output


files=`awk 'NR==14' "$1"`
obs_insar_file=`echo $files | awk '{print $1;}'`
model_insar_file=`echo $files | awk '{print $2;}'`
gmt pscoast -J$proj -R$uav_range -Gwhite -Slightgray -N1 -Wthin,black -B0.2wesn -X-1.3i -Y-1.5i -Dh -K -O >> $output
gmt psxy $ss_fault_file -R -J$proj -Wthinnest,gray -L -K -O >> $output
awk '{print $1, $2, $3*1000}' $obs_insar_file | gmt psxy -Sc0.06 -Clos.cpt -R -J$proj -O -K >> $output
gmt psxy $field_file -R -J$proj -Wthin,indianred -O -K >> $output
...
obs_insar_file=`echo $files | awk '{print $1;}'`
model_insar_file=`echo $files | awk '{print $2;}'`
gmt pscoast -J$proj -R$s1_range -Gwhite -Slightgray -N1 -Wthin,black -B0.2wesn -X-1.3i -Y-1.5i -Dh -K -O >> $output
gmt psxy $ss_fault_file -R -J$proj -Wthinnest,gray -L -K -O >> $output
awk '{print $1, $2, $3*1000}' $obs_insar_file | gmt psxy -Sc0.04 -Clos.cpt -R -J$proj -O -K >> $output
gmt psxy $field_file -R -J$proj -Wthin,indianred -O -K >> $output
echo "-115.545 33.11 D / S1_Asc" | gmt pstext -R -J$projection -F+f12p,Helvetica-bold -K -O >> $output
gmt pscoast -J$proj -R -Gwhite -Slightgray -N1 -Wthin,black -B0.2wesn -X1.3i -Dh -K -O >> $output
gmt psxy $ss_fault_file -R -J$proj -Wthinnest,gray -L -K -O >> $output # Putting the faults on there for kicks
...
awk '{print $1, $2, $3*1000}' $obs_insar_file | gmt psxy -Sc0.04 -Clos.cpt -R -J$proj -O -K >> $output
gmt psxy $field_file -R -J$proj -Wthin,indianred -O -K >> $output
echo "-115.545 33.11 E / S1_Asc" | gmt pstext -R -J$projection -F+f12p,Helvetica-bold -K -O >> $output
gmt pscoast -J$proj -R -Gwhite -Slightgray -N1 -Wthin,black -B0.2wesn -X1.3i -Dh -K -O >> $output
gmt psxy $ss_fault_file -R -J$proj -Wthinnest,gray -L -K -O >> $output # Putting the faults on there for kicks
awk '{print $1, $2, $3*1000}' $model_insar_file | gmt psxy -Sc0.04 -Clos.cpt -R -J$proj -O -K >> $output
gmt psxy $field_file -R -J$proj -Wthin,indianred -O -K >> $output
...
obs_insar_file=`echo $files | awk '{print $1;}'`
model_insar_file=`echo $files | awk '{print $2;}'`
gmt pscoast -J$proj -R$s1_range -Gwhite -Slightgray -N1 -Wthin,black -B0.2wesn -X1.8i -Y4.5i -Dh -K -O >> $output
gmt psxy $ss_fault_file -R -J$proj -Wthinnest,gray -L -K -O >> $output
awk '{print $1, $2, $3*1000}' $obs_insar_file | gmt psxy -Sc0.04 -Clos.cpt -R -J$proj -O -K >> $output
echo "-115.54 33.17 Data" | gmt pstext -R -J$projection -F+f18p,Helvetica-bold -N -K -O >> $output
gmt psxy $field_file -R -J$proj -Wthin,indianred -O -K >> $output
echo "-115.545 33.11 F / S1_Asc" | gmt pstext -R -J$projection -F+f12p,Helvetica-bold -K -O >> $output
gmt pscoast -J$proj -R -Gwhite -Slightgray -N1 -Wthin,black -B0.2wesn -X1.3i -Dh -K -O >> $output
gmt psxy $ss_fault_file -R -J$proj -Wthinnest,gray -L -K -O >> $output # Putting the faults on there for kicks
awk '{print $1, $2, $3*1000}' $model_insar_file | gmt psxy -Sc0.04 -Clos.cpt -R -J$proj -O -K >> $output
gmt psxy $field_file -R -J$proj -Wthin,indianred -O -K >> $output
...
awk '{print $1, $2, $3*1000}' $obs_insar_file | gmt psxy -Sc0.04 -Clos.cpt -R -J$proj -O -K >> $output
gmt psxy $field_file -R -J$proj -Wthin,indianred -O -K >> $output
echo "-115.545 33.11 D / S1_Desc" | gmt pstext -R -J$projection -F+f12p,Helvetica-bold -K -O >> $output
gmt pscoast -J$proj -R -Gwhite -Slightgray -N1 -Wthin,black -B0.2wesn -X1.3i -Dh -K -O >> $output
gmt psxy $ss_fault_file -R -J$proj -Wthinnest,gray -L -K -O >> $output # Putting the faults on there for kicks
awk '{print $1, $2, $3*1000}' $model_insar_file | gmt psxy -Sc0.04 -Clos.cpt -R -J$proj -O -K >> $output
gmt psxy $field_file -R -J$proj -Wthin,indianred -O -K >> $output
...
awk '{print $1, $2, $3*1000}' $obs_insar_file | gmt psxy -Sc0.04 -Clos.cpt -R -J$proj -O -K >> $output
gmt psxy $field_file -R -J$proj -Wthin,indianred -O -K >> $output
echo "-115.545 33.11 E / S1_Desc" | gmt pstext -R -J$projection -F+f12p,Helvetica-bold -K -O >> $output
gmt pscoast -J$proj -R -Gwhite -Slightgray -N1 -Wthin,black -B0.2wesn -X1.3i -Dh -K -O >> $output
gmt psxy $ss_fault_file -R -J$proj -Wthinnest,gray -L -K -O >> $output # Putting the faults on there for kicks
awk '{print $1, $2, $3*1000}' $model_insar_file | gmt psxy -Sc0.04 -Clos.cpt -R -J$proj -O -K >> $output
gmt psxy $field_file -R -J$proj -Wthin,indianred -O -K >> $output
...
awk '{print $1, $2, $3*1000}' $obs_insar_file | gmt psxy -Sc0.04 -Clos.cpt -R -J$proj -O -K >> $output
gmt psxy $field_file -R -J$proj -Wthin,indianred -O -K >> $output
echo "-115.545 33.11 F / S1_Desc" | gmt pstext -R -J$projection -F+f12p,Helvetica-bold -K -O >> $output
gmt pscoast -J$proj -R -Gwhite -Slightgray -N1 -Wthin,black -B0.2wesn -X1.3i -Dh -K -O >> $output
gmt psxy $ss_fault_file -R -J$proj -Wthinnest,gray -L -K -O >> $output # Putting the faults on there for kicks
awk '{print $1, $2, $3*1000}' $model_insar_file | gmt psxy -Sc0.04 -Clos.cpt -R -J$proj -O -K >> $output
gmt psxy $field_file -R -J$proj -Wthin,indianred -O -K >> $output
