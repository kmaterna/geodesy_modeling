...
def drive_uavsar_ts_comparison(myLev, losfile, lonfile, latfile, gps_lon, gps_lat, gps_names,
                               lev_slice, uav_slice, outfile):
...
if __name__ == "__main__":
    ...
    # drive_uavsar_ts_comparison(myLev, uav_los, uav_lon, uav_lat, gps_lons, gps_lats, gps_names, lev_slice=[0, 1],
    #                            uav_slice=[1, 4], outfile=outdir+"one_01_14.png");  # 2009-2011
    # drive_uavsar_ts_comparison(myLev, uav_los, uav_lon, uav_lat, gps_lons, gps_lats, gps_names, lev_slice=[1, 2],
    #                            uav_slice=[4, 6], outfile=outdir+"one_12_46.png");  # 2011 to 2011
    # drive_uavsar_ts_comparison(myLev, uav_los, uav_lon, uav_lat, gps_lons, gps_lats, gps_names, lev_slice=[2, 3],
    #                            uav_slice=[6, 7], outfile=outdir+"one_23_67.png");  # 2011 to 2012
    # drive_uavsar_ts_comparison(myLev, uav_los, uav_lon, uav_lat, gps_lons, gps_lats, gps_names, lev_slice=[3, 4],
    #                            uav_slice=[7, 8], outfile=outdir+"one_34_78.png");  # 2012 to 2013
    # drive_uavsar_ts_comparison(myLev, uav_los, uav_lon, uav_lat, gps_lons, gps_lats, gps_names, lev_slice=[4, 5],
    #                            uav_slice=[8, 9], outfile=outdir+"one_45_89.png");  # 2013 to 2014
    # drive_uavsar_ts_comparison(myLev, uav_los, uav_lon, uav_lat, gps_lons, gps_lats, gps_names, lev_slice=[3, 5],
    #                            uav_slice=[7, 9], outfile=outdir+"one_35_79.png");  # 2012 to 2014
    # drive_uavsar_ts_comparison(myLev, uav_los, uav_lon, uav_lat, gps_lons, gps_lats, gps_names, lev_slice=[5, 8],
    #                            uav_slice=[9, 10], outfile=outdir+"one_58_910.png");  # 2014 to 2017
    # drive_uavsar_ts_comparison(myLev, uav_los, uav_lon, uav_lat, gps_lons, gps_lats, gps_names, lev_slice=[3, 8],
