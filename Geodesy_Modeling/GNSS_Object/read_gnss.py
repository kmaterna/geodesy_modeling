...
def read_station_ts(gps_bbox, gps_reference, remove_coseismic=0):
    ...
    blacklist = [];
    network = 'pbo'
    station_names, _, _ = stations_within_radius.get_stations_within_box(gnss_object.gps_data_config_file,
    ...
    # Importing BRAW
    [myData, offset_obj, eq_obj] = gps_input_pipeline.get_station_data("BRAW", "unr", gnss_object.gps_data_config_file,
                                                                       refframe="NA")
    ...
    for i in range(len(dataobj_list)):
        ...
        newobj = gps_postseismic_remove.remove_by_model(newobj, gnss_object.gps_data_config_file);
